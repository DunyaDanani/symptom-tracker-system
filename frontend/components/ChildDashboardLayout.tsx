...
const navItems = [
  { label: "Dashboard", href: "/dashboard/child", icon: DashboardIcon },
  { label: "Notice", href: "/dashboard/child/notice", icon: NoticeIcon },
  { label: "Messages", href: "/dashboard/child/messages", icon: MessagesIcon },
];

export default function ChildDashboardLayout({
  children,
}: ChildDashboardLayoutProps) {
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-20 bg-blue-900 flex items-center justify-between gap-6 px-8 shrink-0">
          ...
          <div className="flex items-center gap-6">
            ...
            <NotificationBell messagesHref="/dashboard/child/messages" />
