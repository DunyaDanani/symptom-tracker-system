...
export default function TeacherUploadModulesPickerPage() {
  ...
  return (
    <TeacherDashboardLayout>
      ...
      <p className="text-sm text-gray-500 -mt-6 mb-8">
        Select a student to manage their learning modules, past papers, and
        files.
      </p>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {students.map((s) => (
            <Link
              key={s._id}
              href={`/dashboard/teacher/upload-modules/${s._id}`}
