...
export default function TeacherEmotionTrackingListPage() {
  ...
  return (
    <TeacherDashboardLayout>
      ...
      <p className="text-sm text-gray-500 -mt-6 mb-8">
        Select a student to record an emotion check-in or view their history.
      </p>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {students.map((s) => (
            <Link
              key={s._id}
              href={`/dashboard/teacher/students/${s._id}/emotion`}
